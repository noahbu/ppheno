...
base_dir="/home/ubuntu/data/custom/MuskMelon_C/2024-07-30"

# Get the current date and time for logging purposes
current_datetime=$(date +%Y-%m-%d_%H-%M-%S)

# Log file name for all training sessions
log_file="${base_dir}/log_2024-07-30_${current_datetime}.log"
...
output_base_dir="/home/ubuntu/outputs/MuskMelon_C/2024-07-30"
...
do
    if [ -d "$data_dir" ]; then
        ...
        ns-train nerfacto \
            ...
            --project-name "MuskMelon_2024_c_07-30" \
            --vis viewer+wandb \
            --data "$data_dir" \
